...
<html lang="en">
	<head>
	    <title> Euromed 2016 | Welcome </title>
	    <meta charset="utf-8">
	    <link rel="stylesheet" type="text/css" href ="../css_scripts/manifesto.css">
	...
	<body>
	    ...
	    <div id="programButton"> 
	      <button class="button ticketButton"> View the full program </button>
	      <button id="getTickets" class="button ticketButton"> GET TICKETS </button>
	    </div>
